...
<head>
    ...
    <link rel="stylesheet" href="assets/css/main.css?3.0" media="all" />
</head>
                            ...
                            <form class="service" id="AddServices" name="AddServices" method="post"
                                ...
                                <div class="row gtr-50">
                                    ...
                                    <div class="col-6 col-12-small">
                                        ...
                                        <input class="file-input" name="imagenS" id="imagenS" type="file" />
                                    </div>
                                    <div class="col-12">
                                        <label for="descripS">Descripción del Servicio</label>
                                        <textarea class="service" name="descripS" id="descripS"
                                            placeholder="Ingrese la Descripción del Servicio" rows="4"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <ul class="actions">
                                            <li><input type="submit" class="style5" value="Guardar Servicio" /></li>
                                            <li><input type="reset" class="style2" value="Limpiar Campos" /></li>
                                        </ul>
                                    </div>
                                </div>
                            </form>

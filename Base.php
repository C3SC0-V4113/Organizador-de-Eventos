...
<html>
	...
	<body class="no-sidebar is-preload">
		<div id="page-wrapper">
			...
			$Servicios -> setNombre('Servicio 1');
			$Servicios -> setDescripcion('blabalabasjefwhiehe');
			$Servicios -> setURL_Icono('fa-home');
			$Servicios -> ModuloServicios('Nuestros Servicios','SERVICIOS DE CALIDAD','Para que tus eventos sean únicos y especiales');
			?>

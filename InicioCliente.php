...
<body class="no-sidebar is-preload">
            ...
            <!-- Content -->
                <div id="content">
                    <article class="box post">
                        ...
                        Esto es posible gracias a el gran equipo de profesionales que se encuentra detrás de cada acontecimiento, un equipo que se caracteriza por su pasión, especialización, entusiasmo, experiencia y vocación en todo lo que organiza nuestra empresa de eventos</p>
                    </article>
                </div>
            </div>
        <hr>
    <!-- SERVICIOS -->
        ...
        <ul class='actions special'>
            <li><a href='ServiciosCliente.php' class='button style1 large'>Conoce más</a></li><br><br><br>
        </ul>
...
<section id="entrada">
        <section id="highlights" class="wrapper style2">
            ...
            <ul class='actions special'>
                <li><a href='EventosCl.php' class='button style1 large'>Conoce más</a></li>
            </ul>
        </section>
        </section>
    </div>
